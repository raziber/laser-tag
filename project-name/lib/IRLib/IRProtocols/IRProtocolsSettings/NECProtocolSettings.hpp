...
public:
    ...
    uint32_t getLeadingCodeDuration0() const override { return 9000; }
    uint32_t getLeadingCodeDuration1() const override { return 4500; }
    uint32_t getPayloadZeroDuration0() const override { return 560; }
    uint32_t getPayloadZeroDuration1() const override { return 560; }
    uint32_t getPayloadOneDuration0() const override { return 560; }
    uint32_t getPayloadOneDuration1() const override { return 1690; }
